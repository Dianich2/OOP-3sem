...
namespace Lab_15_OOP
{
    public class Program
    {
        ...
        //{
        //    Console.WriteLine($"Запущен dopmethod");
        //    Thread.Sleep(2000);
        //    Console.WriteLine($"dopmethod завершен");
        //}

        //static async Task method10()
        //{
        //    Console.WriteLine($"Запускаем метод method10");
        //    await Task.Run(() => dopmethod());
        //    Console.WriteLine($"Конец метода method10");
        //}
